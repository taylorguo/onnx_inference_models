# https://blog.csdn.net/qq_23604781/article/details/118679008
...
# classes = [line.rstrip('\n') for line in open('samples/coco_classes.txt')]
...
if __name__ == '__main__':
    ...
    # img = Image.open('samples/demo.jpg')
    img = Image.open(sys.argv[3])
    img_data = preprocess(img)

    # display_objdetect_image(img, boxes, labels, scores, masks)

    # ort_session = onnxruntime.InferenceSession("models/MaskRCNN-10.onnx")
    ort_session = onnxruntime.InferenceSession(sys.argv[2])
    outputs = ort_session.run(None, {"image": img_data})
    # print(outputs)
